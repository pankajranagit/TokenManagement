        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    echo form_open(base_url('Admin/Center/'));
                    ?>
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="state" required id="locationstate">


                                    <option value="">Select State</option>

                                    <?php if (!empty($statelist)) {
                                        foreach ($statelist as $stlist) { ?>

                                            <option value="<?php echo $stlist->state_name; ?>"><?php echo $stlist->state_name; ?></option>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= set_value('center_address') ?>" name="center_address" placeholder="Center Address" required class="form-control">
